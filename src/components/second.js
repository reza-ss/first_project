...
<img src={require('../img/pic02.jpg')} title="hi" alt="hi" />
            ...
            <h3>طراحی سایت</h3>
            <p>طراحی وب به مهارت ساخت و راه‌اندازی صفحات وب گفته می‌شود. تیم برنرز لی، مخترع وب، با برپایی یک سایت وب در اوت ۱۹۹۱، نام خود را به عنوان نخستین سازندهٔ وب در تاریخ نگاشت.</p>
        </li>
        <li>
            ...
            <p>بهینه سازی سایت (سئو) به فرآیندی گفته می شود که با استفاده از ترکیب تکنیکهای برنامه نویسی، محتوای سایت و عوامل خارجی تاثیر گذار در رنکینگ گوگل و استفاده از علم سئو باعث افزایش ترافیک و بازدید سایت شما خواهد شد.</p>
        </li>
        <li>
